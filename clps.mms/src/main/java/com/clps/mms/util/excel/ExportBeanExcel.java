...
import com.clps.mms.util.excel.pojo.Student;
...
/**
 * 
* @ClassName: ExportBeanExcel  
* @Description: Excel导出数据流方法  
* @author Clement.chen  
* @date 2018年5月10日 上午10:03:29  
*  
* @param <T>
 */
public class ExportBeanExcel<T> {
     ...
     */
	private static Logger logger = Logger.getLogger(ExportBeanExcel.class);
