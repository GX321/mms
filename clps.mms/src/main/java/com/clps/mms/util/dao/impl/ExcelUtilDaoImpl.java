...
package com.clps.mms.util.dao.impl;
...
/**
 * 
* @ClassName: ExcelUtilDaoImpl  
* @Description: ExcelUtil实现类  
* @author Clement.chen  
* @date 2018年5月11日 上午10:04:31  
*  
* @param <T>
 */
@SuppressWarnings("rawtypes")
public class ExcelUtilDaoImpl<T> implements ExcelUtilDao {
	Class<T> clazz;

	public ExcelUtilDaoImpl(Class<T> clazz) {
		this.clazz = clazz;
	}

	// 实现文件信息从表格导出，引入显示  importFromExcel
	 ...
	 */
	@SuppressWarnings({ })
	public boolean exportToExcel(List list, String sheetName, int sheetSize, OutputStream output) {
